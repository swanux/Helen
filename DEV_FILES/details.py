...
"""
officeonline = """Microsoft Office Online
...
"""
freeoffice = """Softmaker Free Office
...
descDict = {opera : 'App Spotlight', chrome : 'App Spotlight', web : 'App Spotlight', firefox : 'App Spotlight', vivaldi : 'App Spotlight', edge : 'App Spotlight', wps : 'App Spotlight', libreoffice : 'App Spotlight', freeoffice : 'App Spotlight', onlyoffice : 'App Spotlight', gedit : 'App Spotlight', emacs : 'App Spotlight', code : 'App Spotlight', atom : 'App Spotlight', stext : 'App Spotlight', geany : 'App Spotlight', skype : 'App Spotlight', discord : 'App Spotlight', telegram : 'App Spotlight', signal : 'App Spotlight', hexchat : 'App Spotlight', franz : 'App Spotlight', ad : 'App Spotlight', tux : 'App Spotlight', lutris : 'App Spotlight', pol : 'App Spotlight', steam : 'App Spotlight', minecraft : 'App Spotlight', tuxkart : 'App Spotlight', popsicle : 'App Spotlight', woeusb : 'App Spotlight', wine : 'App Spotlight', vbox : 'App Spotlight', gparted : 'App Spotlight', gestures : 'App Spotlight', audacity : 'App Spotlight', officeonline : 'App Spotlight', gsuite : 'App Spotlight', deja : 'App Spotlight', timeshift : 'App Spotlight', teamv : 'App Spotlight', box : 'App Spotlight', barrier : 'App Spotlight', mint : 'Distro Boutique', ubuntu : 'Distro Boutique', solus : 'Distro Boutique', deepin : 'Distro Boutique', elementary : 'Distro Boutique', zorin : 'Distro Boutique', steamos : 'Distro Boutique', debian : 'Distro Boutique',fedora : 'Distro Boutique', opensuse : 'Distro Boutique', arch : 'Distro Boutique', gentoo : 'Distro Boutique', lfs : 'Distro Boutique'}
