...
def my_thread():
    if g.CA == 'Opera':
        if g.distro == 'Ubuntu':
            os.system('DEBIAN_FRONTEND=noninteractive apt install opera-stable pepperflashplugin-nonfree -y')
        elif g.distro == 'Arch':
        ...
        if g.distro == 'Ubuntu':
            os.system('apt install google-chrome-stable -y')
        elif g.distro == 'Arch':
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge google-chrome-stable -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm google-chrome')
    elif g.CA == 'Web':
        if g.distro == 'Ubuntu':
            os.system('apt install epiphany-browser -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm epiphany')
    elif g.CA == 'WebR':
        if g.distro == 'Ubuntu':
            os.system('apt purge epiphany-browser -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm epiphany')
    elif g.CA == 'Firefox':
        if g.distro == 'Ubuntu':
            os.system('apt install firefox firefoxdriver -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm firefox')
    elif g.CA == 'FirefoxR':
        if g.distro == 'Ubuntu':
            os.system('apt purge firefox* -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm firefox')
    elif g.CA == 'Vivaldi':
        if g.distro == 'Ubuntu':
            os.system('apt install vivaldi-stable -y')
        elif g.distro == 'Arch':
            g.fold = 'vivaldi'
            g.num = 2
            app.aurer()
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge vivaldi-stable -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm vivaldi')
    elif g.CA == 'Only Office':
        if g.distro == 'Ubuntu':
            os.system('apt install onlyoffice-desktopeditors -y')
        elif g.distro == 'Arch':
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge onlyoffice-desktopeditors -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm onlyoffice-bin')
    elif g.CA == 'Free Office':
        if g.distro == 'Ubuntu':
            os.system('apt install softmaker-freeoffice-2018 -y')
        elif g.distro == 'Arch':
            g.fold = 'freeoffice'
            g.num = 1
            app.aurer()
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge softmaker-freeoffice-2018 -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --nocnonfirm freeoffice')
    elif g.CA == 'Gedit':
        if g.distro == 'Ubuntu':
            os.system('apt install gedit -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm gedit')
    elif g.CA == 'GeditR':
        if g.distro == 'Ubuntu':
            os.system('apt purge gedit -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm gedit')
    elif g.CA == 'GNU Emacs':
        if g.distro == 'Ubuntu':
            os.system('apt install emacs26 -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm emacs')
    elif g.CA == 'GNU EmacsR':
        if g.distro == 'Ubuntu':
            os.system('apt purge emacs26 -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm emacs')
    elif g.CA == 'Visual Studio Code':
        if g.distro == 'Ubuntu':
            os.system('apt install code -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm code')
    elif g.CA == 'Visual Studio CodeR':
        if g.distro == 'Ubuntu':
            os.system('apt purge code -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm code')
    elif g.CA == 'Atom Editor':
        if g.distro == 'Ubuntu':
            os.system('apt install atom -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm atom')
    elif g.CA == 'Atom EditorR':
        if g.distro == 'Ubuntu':
            os.system('apt purge atom -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm atom')
    elif g.CA == 'Sublime Text Editor':
        if g.distro == 'Ubuntu':
            os.system('apt install sublime-text -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm sublime-text')
    elif g.CA == 'Sublime Text EditorR':
        if g.distro == 'Ubuntu':
            os.system('apt purge sublime-text -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm sublime-text')
    elif g.CA == 'Geany':
        if g.distro == 'Ubuntu':
            os.system('apt install geany -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm geany')
    elif g.CA == 'GeanyR':
        if g.distro == 'Ubuntu':
            os.system('apt purge geany -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm geany')
    elif g.CA == 'Discord':
        if g.distro == 'Ubuntu':
            os.system('apt install discord -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm discord')
    elif g.CA == 'DiscordR':
        if g.distro == 'Ubuntu':
            os.system('apt purge discord -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm discord')
    elif g.CA == 'Telegram':
        if g.distro == 'Ubuntu':
            os.system('apt install telegram-desktop -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm telegram-desktop')
    elif g.CA == 'TelegramR':
        if g.distro == 'Ubuntu':
            os.system('apt purge telegram-desktop -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm telegram-desktop')
    elif g.CA == 'Signal':
        if g.distro == 'Ubuntu':
            os.system('apt install signal-desktop -y')
        elif g.distro == 'Arch':
            g.fold = 'signal'
            g.num = 2
            app.aurer()
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge signal-desktop -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm signal')
    elif g.CA == 'HexChat':
        if g.distro == 'Ubuntu':
            os.system('apt install hexchat hexchat-indicator -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm hexchat')
    elif g.CA == 'HexChatR':
        if g.distro == 'Ubuntu':
            os.system('apt purge hexchat hexchat-indicator -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm hexchat')
    elif g.CA == 'SuperTux':
        if g.distro == 'Ubuntu':
            os.system('apt install supertux -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm supertux')
    elif g.CA == 'SuperTuxR':
        if g.distro == 'Ubuntu':
            os.system('apt purge supertux -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm supertux')
    elif g.CA == 'Play On Linux':
        if g.distro == 'Ubuntu':
            os.system('apt install playonlinux -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm playonlinux')
    elif g.CA == 'Play On LinuxR':
        if g.distro == 'Ubuntu':
            os.system('apt purge playonlinux -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm playonlinux')
    elif g.CA == 'Minecraft':
        if g.distro == 'Ubuntu':
            os.system('wget -o ~/Minecraft.deb https://launcher.mojang.com/download/Minecraft.deb && dpkg -i --force-all Minecraft.deb && apt install -f -y && rm Minecraft.deb')
        elif g.distro == 'Arch':
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge minecraft-launcher -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm minecraft-launcher')
    elif g.CA == 'TeamViewer':
        if g.distro == 'Ubuntu':
            os.system('apt install teamviewer -y')
        elif g.distro == 'Arch':
            ...
            os.system('cd teamviewer && ./tv-setup install force')
    elif g.CA == 'TeamViewerR':
        if g.distro == 'Ubuntu':
            os.system('apt purge teamviewer -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('cd teamviewer && ./tv-setup uninstall force')
            os.system('rm -rf teamviewer && rm -rf /opt/teamviewer')
    elif g.CA == 'Gnome Boxes':
        if g.distro == 'Ubuntu':
            os.system('apt install gnome-boxes -y')
        elif g.distro == 'Arch':
            os.system('pacman -S --noconfirm gnome-boxes')
    elif g.CA == 'Gnome BoxesR':
        if g.distro == 'Ubuntu':
            os.system('apt purge gnome-boxes -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm gnome-boxes')
    elif g.CA == 'Franz':
        if g.distro == 'Ubuntu':
            os.system('apt install franz -y')
        elif g.distro == 'Arch':
            g.num = 2
            g.fold = 'franz'
            app.aurer()
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge franz -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm franz')
        ...
        if g.distro == 'Ubuntu':
            os.system('DEBIAN_FRONTEND=noninteractive apt install wps-office ttf-wps-fonts -y')
        elif g.distro == 'Arch':
            g.num = 2
            g.fold = 'wps-office'
            app.aurer()
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge ttf-wps-fonts wps-office -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm wps-office ttf-wps-fonts')
    elif g.CA == 'Popsicle':
        if g.distro == 'Ubuntu':
            os.system('apt install popsicle* -y')
        elif g.distro == 'Arch':
            g.fold = 'popsicle-git'
            g.num = 3
            app.aurer()
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge popsicle* -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm popsicle-gtk-git')
    elif g.CA == 'Wine':
        if g.distro == 'Ubuntu':
        ...
        if g.distro == 'Ubuntu':
            ...
            os.system('pacman -Sq --noconfirm virtualbox && /sbin/rcvboxdrv setup')
        ...
        if g.distro == 'Ubuntu':
            os.system('apt install woeusb -y')
        elif g.distro == 'Arch':
            g.num = 2
            g.fold = 'woeusb'
            app.aurer()
        ...
        if g.distro == 'Ubuntu':
            ...
            os.system('pacman -Sq --noconfirm gparted gpart')
    elif g.CA == 'GPartedR':
        if g.distro == 'Ubuntu':
            os.system('apt purge gpart* -y && apt autoremove -y')
        elif g.distro == 'Arch':
            os.system('pacman -Runs --noconfirm gparted')
    elif g.CA == 'Audacity':
        if g.distro == 'Ubuntu':
        ...
        if g.distro == 'Ubuntu':
            os.system('apt install libinput-tools libinput-bin wmctrl python3 xdotool -y')
            os.system('gpasswd -a %s input' % g.user)
        ...
        if g.distro == 'Ubuntu':
            os.system('apt purge libinput-tools xdotool libinput-bin -y && apt autoremove -y')
        ...
        if g.distro == 'Ubuntu':
            os.system('apt install skypeforlinux -y')
        elif g.distro == 'Arch':
            g.num = 3
...
class GUI:
    ...
    def aurer(self):
        ...
        lines[4] = 'runuser -l $persist -c "mkdir .tmp_hsuite && %s"' % cmd
        with open("logname.sh", "w") as f:
            f.writelines(lines)
        os.system('./logname.sh')
        ...
        pkg = pkg[g.num]
        print(pkg)
        os.system('pacman -U --noconfirm /home/%s/.tmp_hsuite/%s/%s && rm -rf /home/%s/.tmp_hsuite/' % (g.user, g.fold, pkg, g.user))
    ...
    def __init__(self):
        ...
        info_txt = self.builder.get_object('info_txt')
        if g.distro == 'Arch':
            aureORnot = '''
Welcome to App Spotlight. Here are lots of high qualitiy programs sorted by category. You can easly switch between browsers, find the best office suite or install a good game. 

If you click on the icon of the program, you'll see some extra informations about that. And after you decided to install or remove it, you can easly do that by just clicking on the button below the icon.

NOTE: Installation from AUR could take a very long time, even in the case of small programs (5-17 mins).
'''
...
#        g.name = 'name'
#        self.OnCheck()
        edge_but.set_label("Coming soon") #(g.status)
#        g.edge_value = g.status
        ...
        if g.distro == 'Arch':
            ...
            g.name = 'softmaker-freeoffice-2018'
        else:
            print('EROOR IN NAME')
        self.OnCheck()
        self.stamp()
    ...
    def button_clicked (self, button):
        if os.geteuid() != 0:
            ...
            dialogWindow = Gtk.MessageDialog(None,
                                  ...
                                  Gtk.MessageType.QUESTION,
                                  Gtk.ButtonsType.YES_NO,
                                  "You need root acces to install or remove programs, so it is required to rerun the program as root. Would you like to do it now?")
            dialogWindow.set_title("Rerun as root now?")
            dsx, dsy = dialogWindow.get_size()
            dialogWindow.move(x+((sx-dsx)/2), y+((sy-dsy)/2))
            dialogWindow.show_all()
            res = dialogWindow.run()
    ...
    def OnNeed(self):
        ...
        def counter(timer):
            ...
            if g.name+'R' == g.CA:
                ...
                sTxt.set_label(g.inMsg+'         Elapsed time : '+str(g.m)+':'+str(s)+'        It will take around %d minutes.' % g.kbTime)
            if s == 59:
                timer.count = -1
                g.m = g.m+1
            if t1.isAlive():
...
#        view_fb = self.builder.get_object('view_fb')
#        web_box = self.builder.get_object('web_box')
        os.system("exo-open https://swanux.github.io/hsuite/")
#        view_fb.add(g.browserholder)
#        g.browserholder.show()
#        g.stack.set_visible_child(web_box)
...
############################################################################
    ...
    def on_edge_but_clicked(self, button):
        g.name = 'Edge'
#        if g.edge_value == 'Install':
#            g.kbTime = 0
#            self.onIns()
#        elif g.edge_value == 'Remove':
#            self.onRem()
#        print(g.CA)
#        self.OnNeed()
    ...
    def on_msoffice_but_clicked(self, button):
        os.system("exo-open https://office.com")

    def on_goffice_but_clicked(self, button):
        os.system("exo-open https://docs.google.com")
...
#        if g.wot_value == 'Install':
#            g.kbTime = 0
#            self.onIns()
#        elif g.wot_value == 'Remove':
#            self.onRem()
#        print(g.CA)
#        self.OnNeed()
    ...
    def on_gest_but_clicked(self, button):
        ...
        dialogWindow = Gtk.MessageDialog(None,
                              ...
                              Gtk.MessageType.QUESTION,
                              Gtk.ButtonsType.YES_NO,
                              "You can currently only use this feature with Xorg based desktop. It does not support Wayland. Are you sure that you use Xorg?")
        dialogWindow.set_title("Prompt")
        dsx, dsy = dialogWindow.get_size()
        dialogWindow.move(x+((sx-dsx)/2), y+((sy-dsy)/2))
        dx, dy = dialogWindow.get_position()
        ...
        if res == Gtk.ResponseType.YES:
            ...
            dialogWindow = Gtk.MessageDialog(None,
                                  ...
                                  Gtk.MessageType.INFO,
                                  Gtk.ButtonsType.OK,
                                  "You need to reboot later to apply all changes. (Will not reboot if you press OK now.)")
            dialogWindow.set_title("Friendly reminder")
            dsx, dsy = dialogWindow.get_size()
            dialogWindow.move(x+((sx-dsx)/2), y+((sy-dsy)/2))
            dialogWindow.show_all()
            res = dialogWindow.run()
    ...
    def on_back_button_clicked (self, button):
        if g.spinning:
            ...
            if res == Gtk.ResponseType.YES:
                ...
                print('Spinning')
                if g.distro == 'Ubuntu':
                    os.system('killall apt apt-get && echo "Configuring..." && dpkg --configure -a && apt autoremove -y && apt autoclean -y')
                elif g.distro == 'Arch':
                    os.system('rm /var/lib/pacman/db.lck && killal pacman && pacman -R $(pacman -Qdtq)')
                else:
